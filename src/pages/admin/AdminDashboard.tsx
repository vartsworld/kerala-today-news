...
import { FileText, Newspaper, Settings, LogOut, Facebook } from "lucide-react";
          ...
          <CardContent className="py-4">
            <div className="grid gap-2 sm:flex sm:flex-wrap sm:gap-3">
              <Button asChild className="w-full sm:w-auto">
                <Link to="/admin/write" className="hover-scale">
                  <FileText className="mr-2 h-4 w-4" /> Write editorial
                </Link>
              </Button>
