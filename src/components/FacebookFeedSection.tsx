...
const FacebookFeedSection = () => {
  ...
  return <section className="container mx-auto py-12">
      <header className="mb-4 sm:mb-6">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Achayans Media</h2>
        <p className="text-sm sm:text-base text-muted-foreground">All the latest updates from Achayans Media</p>
      </header>
      <Carousel opts={{
      align: "start"
    }}>
        <CarouselContent className="-ml-2 md:-ml-4">
          ...
          const excerpt = post.message?.slice(0, 160) || "";
           return <CarouselItem key={post.id} className="pl-2 md:pl-4 basis-4/5 sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
