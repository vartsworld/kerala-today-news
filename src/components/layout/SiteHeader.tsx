...
const SiteHeader = () => {
  ...
  return (
    <header
      className={`sticky top-0 z-40 w-full transition-all duration-500 ease-in-out left-0 right-0 ${scrolled
        ? "py-2 sm:py-3"
        : "py-0"
        }`}
    >
      <div
        className={`transition-all duration-500 ease-in-out border-b ${scrolled
          ? "bg-background/95 backdrop-blur-md shadow-2xl rounded-b-[40px] sm:rounded-b-[60px] border-none mx-auto max-w-[95%] sm:max-w-[90%]"
          : "bg-background mx-auto max-w-full"
          }`}
      >
